...
function randomInteger(min, max) {
  ...
  /**
   *Math.random() gives you a number between 0-1 examples: 0.13,0.4,0.00019
   *Math.floor() is a fuction where round a number for example: Math.floor(5.8) = 5
   *(max- min + 1) makes sure that the operation gives you the max numer
   *while +min makes sure that the operation gives you the min number
   */
}
